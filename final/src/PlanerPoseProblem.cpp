...
{
    for( int i = 0 ; i < m_simulator->num_reorient_CW+1 ; i++)
    {
        m_simulator->unit_pushes_CW.push_back( m_simulator->ni_CW[i][0] );
        m_simulator->unit_pushes_CW.push_back( m_simulator->ni_CW[i][1] );
        m_simulator->unit_pushes_CW.push_back( m_simulator->ni_CW[i][2] );
    }
    for( int i = 0 ; i < m_simulator->num_reorient_CW ; i++ )
    {
        m_simulator->unit_pushes_CW.push_back( m_simulator->unit_reorient_CW[i] );
    }
...
void PlanerPoseProblem::ProduceMoves( )
{
